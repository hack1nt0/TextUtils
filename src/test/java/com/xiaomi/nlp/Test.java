...
import com.xiaomi.nlp.classification.spamsms.CommonCharacterTransformer;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        CommonCharacterTransformer commonCharacterTransformer = new CommonCharacterTransformer().setDict();

        System.out.println(commonCharacterTransformer.cal(str));
